...
import { getCurrentWeekRomStatus, getFourWeekRomStatus } from "@/lib/romStatusHistory";
...
export function RomStatusDashboard({ days, dashboardRef, exporting, onExport, routineCompletion, exportMeta, onChangeMeta, monthlySummary }: RomStatusDashboardProps) {
