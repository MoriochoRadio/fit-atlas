...
const mainItems: Record<SessionGoal, Record<SessionEnvironment, string[]>> = {
  ...
  all_round: {
    home: ["케틀벨 데드리프트 또는 의자 일어서기·도달 · 2세트", "지지 인버티드 로우 또는 아처 푸시업 프렙 · 2세트", "할로우 턱 홀드 또는 사이드 플랭크 힙 어브덕션 니 · 좌우 2세트", "편안한 제자리 걷기"],
    gym: ["레그 프레스 또는 유니래터럴 레그 프레스 · 2세트", "케이블 싱글 암 로우 또는 어시스트 딥 머신 · 2세트", "일립티컬 이지 또는 트레드밀 템포 워크 · 편안한 강도", "케이블 싱글 암 체스트 프레스 또는 팔로프 프레스 · 좌우 2세트"],
