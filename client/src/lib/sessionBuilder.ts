...
const mainItems: Record<SessionGoal, Record<SessionEnvironment, string[]>> = {
  strength: {
    home: ["케틀벨 데드리프트 또는 높은 지지 힙 쓰러스트 · 2세트", "지지 풀업 네거티브 또는 핸드 릴리스 푸시업 · 2세트", "지지 피스톨 스쿼트 투 박스 또는 지지 스케이터 스쿼트 · 2세트", "발 지지 액티브 행 또는 버드 독 · 좌우 6회"],
    gym: ["레그 프레스 또는 샌드백 프런트 스쿼트 · 2–3세트", "머신 인클라인 체스트 프레스 또는 랜드마인 프레스 · 2–3세트", "어시스트 친업 머신 또는 케이블 스트레이트 암 풀다운 · 2–3세트", "머신 앱 크런치 또는 케이블 스탠딩 힙 어브덕션 · 2세트"],
  ...
  all_round: {
    home: ["케틀벨 데드리프트 또는 의자 일어서기·도달 · 2세트", "지지 인버티드 로우 또는 아처 푸시업 프렙 · 2세트", "지지 Y 밸런스 리치 또는 크로스 바디 탭 밸런스 · 좌우 2세트", "편안한 제자리 걷기"],
    gym: ["레그 프레스 또는 유니래터럴 레그 프레스 · 2세트", "케이블 싱글 암 로우 또는 어시스트 친업 머신 · 2세트", "일립티컬 이지 또는 트레드밀 템포 워크 · 편안한 강도", "케이블 싱글 암 체스트 프레스 또는 팔로프 프레스 · 좌우 2세트"],
