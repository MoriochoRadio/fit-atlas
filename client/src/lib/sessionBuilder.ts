...
const mainItems: Record<SessionGoal, Record<SessionEnvironment, string[]>> = {
  strength: {
    home: ["케틀벨 데드리프트 또는 지지 리버스 런지 · 2세트", "지지 인버티드 로우 또는 카운터 인클라인 푸시업 · 2세트", "지지 불가리안 스플릿 스쿼트 또는 얕은 월 싯 · 2세트", "노르딕 컬 프렙 또는 버드 독 · 좌우 6회"],
    gym: ["레그 프레스 또는 샌드백 프런트 스쿼트 · 2–3세트", "머신 인클라인 체스트 프레스 또는 랜드마인 프레스 · 2–3세트", "체스트 서포티드 로우 또는 케이블 바이셉스 컬 · 2–3세트", "케이블 스탠딩 힙 어브덕션 또는 머신 힙 어브덕션 · 2세트"],
  ...
  endurance: {
    ...
    gym: ["리컴번트 바이크·일립티컬·로잉 에르고미터 이지 중 선택", "대화 가능한 강도에서 지속", "자세가 무너지면 저항을 낮추기"],
    outdoor: ["템포 워크·런 또는 트레킹 폴 워크 프렙", "경사 조그·워크는 호흡이 편안할 때만", "더운 날에는 그늘·물·낮은 페이스 우선"],
  },
  all_round: {
