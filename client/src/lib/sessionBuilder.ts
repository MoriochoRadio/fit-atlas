...
const mainItems: Record<SessionGoal, Record<SessionEnvironment, string[]>> = {
  strength: {
    home: ["케틀벨 데드리프트 또는 높은 지지 힙 쓰러스트 · 2세트", "지지 풀업 네거티브 또는 발 지지 오버핸드 풀업 · 2세트", "지지 피스톨 스쿼트 투 박스 또는 지지 스케이터 스쿼트 · 2세트", "발 지지 풀업 포즈 래더 또는 버드 독 · 좌우 6회"],
  ...
  all_round: {
    home: ["케틀벨 데드리프트 또는 의자 일어서기·도달 · 2세트", "로우 바 그립 전환 로우 또는 아처 푸시업 프렙 · 2세트", "지지 Y 밸런스 리치 또는 크로스 바디 탭 밸런스 · 좌우 2세트", "편안한 제자리 걷기"],
