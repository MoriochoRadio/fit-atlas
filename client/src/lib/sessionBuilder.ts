...
const mainItems: Record<SessionGoal, Record<SessionEnvironment, string[]>> = {
  strength: {
    home: ["케틀벨 데드리프트 또는 지지 리버스 런지 · 2세트", "저항 밴드 로우 또는 높은 지지면 푸시업 · 2세트", "얕은 월 싯 · 15–30초 × 2회", "버드 독 · 좌우 6회"],
    gym: ["레그 프레스 또는 샌드백 프런트 스쿼트 · 2–3세트", "케이블 체스트 프레스 또는 랜드마인 프레스 · 2–3세트", "체스트 서포티드 로우 또는 TRX 로우 · 2–3세트", "머신 힙 어브덕션 · 2세트"],
    outdoor: ["로우 스텝 마치 · 좌우 2세트", "로우 스텝 레터럴 탭 · 좌우 2세트", "스냅 다운 · 3–5회", "탠덤 스탠스 · 좌우 20초"],
  },
  endurance: {
  ...
  all_round: {
    home: ["케틀벨 데드리프트 또는 의자 앉았다 일어나기 · 2세트", "저항 밴드 로우 또는 높은 지지면 푸시업 · 2세트", "버드 독 · 좌우 6회", "편안한 제자리 걷기"],
    gym: ["레그 프레스 또는 샌드백 프런트 스쿼트 · 2세트", "체스트 서포티드 로우 또는 TRX 로우 · 2세트", "일립티컬 이지 또는 리컴번트 바이크 · 편안한 강도", "가벼운 샌드백 베어허그 캐리 또는 팔로프 프레스 · 좌우 2세트"],
    outdoor: ["빠른 걷기", "로우 스텝 마치 또는 카프 레이즈", "로우 스텝 레터럴 탭 · 짧은 거리", "발목 니투월 락"],
  },
};
