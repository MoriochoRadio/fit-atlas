...
const mainItems: Record<SessionGoal, Record<SessionEnvironment, string[]>> = {
  ...
  all_round: {
    ...
    gym: ["레그 프레스 또는 유니래터럴 레그 프레스 또는 벨트 스쿼트 머신 이지 · 2세트", "케이블 싱글 암 로우 또는 플레이트 로디드 하이 로우 이지 또는 어시스트 뉴트럴 그립 풀업 머신 · 2세트", "일립티컬 이지 또는 트레드밀 템포 워크 · 편안한 강도", "머신 딥 프레스 이지 또는 케이블 레터럴 레이즈 이지 또는 케이블 싱글 암 체스트 프레스 또는 팔로프 프레스 · 좌우 2세트"],
