...
const mainItems: Record<SessionGoal, Record<SessionEnvironment, string[]>> = {
  strength: {
    home: ["케틀벨 데드리프트 또는 맨몸 굿모닝 · 2세트", "지지 풀업 네거티브 또는 발 지지 오버핸드 풀업 · 2세트", "지지 피스톨 스쿼트 투 박스 또는 지지 레터럴 런지 · 2세트", "발 지지 풀업 포즈 래더 또는 데드 버그 콘트랄래터럴 리치 · 좌우 6회"],
  ...
  all_round: {
    home: ["스쿼트 투 카프 레이즈 또는 의자 일어서기·도달 · 2세트", "로우 바 그립 전환 로우 또는 아처 푸시업 프렙 · 2세트", "지지 Y 밸런스 리치 또는 지지 레터럴 런지 · 좌우 2세트", "베어 크롤 포워드 이지 또는 편안한 제자리 걷기"],
