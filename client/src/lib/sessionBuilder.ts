...
const mainItems: Record<SessionGoal, Record<SessionEnvironment, string[]>> = {
  strength: {
    ...
    gym: ["레그 프레스 · 2–3세트", "케이블 체스트 프레스 · 2–3세트", "체스트 서포티드 로우 · 2–3세트", "머신 힙 어브덕션 · 2세트"],
    outdoor: ["낮은 스텝업 · 좌우 2세트", "월 싯 · 20–30초 × 2회", "스냅 다운 · 3–5회", "탠덤 스탠스 · 좌우 20초"],
  },
  endurance: {
    home: ["제자리 걷기 또는 낮은 스텝업", "편안한 속도 2–4분 + 천천히 1분 반복", "가동성 1–2개를 회복 구간에 배치"],
    gym: ["스테디 사이클·엘립티컬·스테어 클라이머 이지 중 선택", "대화 가능한 강도에서 지속", "자세가 무너지면 저항을 낮추기"],
  ...
  all_round: {
    ...
    gym: ["레그 프레스 또는 머신 힙 어브덕션 · 2세트", "체스트 서포티드 로우 또는 케이블 체스트 프레스 · 2세트", "스테어 클라이머 이지 · 편안한 강도", "팔로프 프레스 · 좌우 2세트"],
    outdoor: ["빠른 걷기", "낮은 스텝업 또는 카프 레이즈", "로우 콘 셔플 · 짧은 거리", "발목 니투월 락"],
  },
};
