...
const mainItems: Record<SessionGoal, Record<SessionEnvironment, string[]>> = {
  strength: {
    ...
    gym: ["레그 프레스 또는 케틀벨 고블릿 스쿼트 · 2–3세트", "케이블 체스트 프레스 · 2–3세트", "체스트 서포티드 로우 · 2–3세트", "머신 힙 어브덕션 · 2세트"],
  ...
  all_round: {
    ...
    gym: ["레그 프레스 또는 케틀벨 고블릿 스쿼트 · 2세트", "체스트 서포티드 로우 또는 케이블 체스트 프레스 · 2세트", "일립티컬 이지 또는 리컴번트 바이크 · 편안한 강도", "팔로프 프레스 · 좌우 2세트"],
