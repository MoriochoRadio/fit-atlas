...
export const expandedExercisesPart6: Exercise[] = [
  {
  ...
  },
  {
    ...
    reference: sources.aceSuspension,
  },
  {
  ...
  },
  {
    ...
    cues: ["작은 범위만 사용", "팔꿈치를 구부려 당기지 않기", "목을 길게 유지"],
  ...
  },
  {
    ...
    reference: sources.redCrossSwim,
  },
];
