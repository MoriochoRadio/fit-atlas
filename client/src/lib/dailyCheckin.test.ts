...
describe("daily check-in", () => {
  ...
  it("accepts half-step check-in values while rejecting unsupported precision", () => {
    expect(readDailyCheckin('{"date":"2026-08-14","energy":2.5,"sleep":3.5,"stress":2,"pain":1.5}')).toMatchObject({ energy: 2.5, sleep: 3.5, pain: 1.5 });
    expect(readDailyCheckin('{"date":"2026-08-14","energy":2.2,"sleep":3,"stress":2,"pain":1}').energy).toBe(3);
  });
