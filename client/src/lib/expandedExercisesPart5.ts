...
export const expandedExercisesPart5: Exercise[] = [
  {
  ...
  },
  {
    ...
    minutes: "10–25분 · RPE 3–5",
    description:
      "등받이에 지지된 자세에서 낮은 저항으로 페달을 돌리며 하체 유산소 리듬을 쌓는 선택지입니다.",
    cues: [
      "시트 거리를 무릎이 너무 접히지 않게 조절",
      "낮은 저항으로 몇 분 적응",
      "발을 페달 중앙에 편안히 두기",
    ],
    benefits: ["지지형 저충격 유산소", "하체 리듬", "운동 재개 선택지"],
    warning:
      "무릎·고관절 통증이 증가하거나 다리 저림이 생기면 시트·저항을 조절하거나 중단하세요.",
    reference: sources.cdc,
  },
  {
    id: "row-erg-easy",
    ...
    minutes: "8–20분 · 낮은 저항",
    description:
      "낮은 저항에서 다리-몸통-팔 순서로 천천히 당기고 돌아오며 전신 유산소 리듬을 연습합니다.",
    cues: [
      "발 스트랩과 댐퍼를 낮게 설정",
      "다리로 밀고 몸통·팔을 뒤따르게",
      "허리를 젖히지 않고 부드럽게 복귀",
    ],
    benefits: ["전신 유산소", "당기기 리듬", "다리·등 협응"],
    warning:
      "허리 통증·어지러움·손잡이를 당기며 등이 둥글어지는 자세가 생기면 강도와 범위를 낮추거나 중단하세요.",
    reference: sources.cdc,
  },
];
