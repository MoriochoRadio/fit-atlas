...
describe("movement visual guides", () => {
  it("provides three labelled frames for representative complex exercises", () => {
    expect(Object.keys(movementVisuals)).toEqual(expect.arrayContaining(["squat", "pushup", "rdl", "run", "single-leg-stand", "row", "reverse-lunge", "snap-down", "squat-jump-stick", "lateral-bound-stick", "cable-chest-press", "ankle-knee-to-wall", "kettlebell-deadlift", "resistance-band-row", "low-step-march", "sandbag-bear-hug-carry", "trx-row", "landmine-press", "landmine-rotation-prep"]));
