...
describe("movement visual guides", () => {
  it("provides three labelled frames for representative complex exercises", () => {
    ...
    expect(getMovementVisual("row-erg-easy")?.title).toContain("로잉 에르고미터");
