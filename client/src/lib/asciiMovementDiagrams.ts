...
export const asciiMovementDiagrams: Record<string, AsciiMovementDiagram> = {
  ...
  "rowing-ergometer": { title: "로잉 에르고미터 ASCII 도식", description: "다리·몸통·팔 순서로 밀고, 반대 순서로 돌아오는 흐름입니다.", stages: [{ label: "캐치", art: erg, cue: "낮은 저항·몸통 길게" }, { label: "드라이브", art: erg, cue: "다리·몸통·팔 순서" }, { label: "복귀", art: erg, cue: "팔·몸통·다리 순서" }] },
